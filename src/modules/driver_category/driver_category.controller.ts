...
export class DriverCategoryController {
    constructor(private readonly driver_category_service:DriverCategoryService){
    }
    ...
    @Post()
    create_driver_category(@Body() type_situation: CreateDriverCategoryDto): Promise<driver_category> {

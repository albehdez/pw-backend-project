...
export class ProgramingTypeController {
    constructor(private readonly programing_type_service:ProgramingTypeService){}
    ...
    @Post()
    create_programing_type(@Body() programing_type:CreateProgramingTypeDto):Promise<programing_type>{

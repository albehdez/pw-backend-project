...
export class TransportService {
    constructor(@InjectRepository(transport) private readonly transportRepository: Repository<transport>,
    ...
    async create_transport({is_copilot, car, driver  }: CreateTransportDto): Promise<transport> {
     ...
     async update_transport(id: number, {  is_copilot, car, driver}: UpdateTransportDto): Promise<transport> {

...
export class DriverSituationController {
    constructor(private readonly driver_situation_service:DriverSituationService){
    }
    ...
    @Post()
    create_driver_situation(@Body() type_situation: CreateCarSituationDto): Promise<driver_situation> {
